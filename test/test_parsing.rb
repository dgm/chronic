...
class TestParsing < Test::Unit::TestCase
  ...
  def test_parse_guess_dates
    ...
    time = parse_now("2006-08-20 03:00") # ambiguous, the ambigious range should make this 3pm
    assert_equal Time.local(2006, 8, 20, 15), time
    ...
    time = parse_now("5/19/2011 01:10 pm")
    assert_equal Time.local(2011, 5, 19, 13, 10, 00), time
